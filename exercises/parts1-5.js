...
// console.log(`${spacecraftName} would take ${getDaysToLocation(kilometersToMars)} days to get to Mars; and ${getDaysToLocation(kilometersToTheMoon)} days to get to the moon`);
